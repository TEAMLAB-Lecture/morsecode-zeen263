...
def is_validated_english_sentence(user_input):
    ...
    Examples:
        ...
        True
    """
    punctuations = {'.':True, ',':True, '!':True, '?':True, ' ':True}
    sentence = user_input
...
def get_cleaned_english_sentence(raw_english_sentence):
    ...
    """
    punctuations = {'.': True, ',': True, '!': True, '?': True}
    sentence = raw_english_sentence.strip()
...
def decoding_character(morse_character):
    ...
    Examples:
        ...
        'K'
    """
    alphabet = get_alphabet_dict()
    return alphabet[morse_character]
...
def encoding_character(english_character):
    ...
    return morse[english_character]
...
def decoding_sentence(morse_sentence):
    ...
    for cord in morse_sentence.split('  '):
        word = list(map(decoding_character, cord.split()))
        sentence_alpha.append(''.join(word))

    return ' '.join(sentence_alpha)
...
def encoding_sentence(english_sentence):
    ...
    for word in sentence:
        cord = list(map(encoding_character, word))
        sentence_morse.append(' '.join(cord))

    return '  '.join(sentence_morse)
...
def main():
    ...
    while True:
        ...
        check_result = input_checker(user_input)

        if check_result == 'EXIT':
            break

        elif check_result == 'HELP':
            print(get_help_message())

        elif check_result == 'TO_MORSE':
            print(encoding_sentence(user_input))

        elif check_result == 'TO_ENG':
